...
int main()
{
    ...
    if (1)
    {
        ...
        d1.set(2025, 11, 28); // 2025.11.28
        d2.set(2025, 11);     // 2025.11.1
        d3.set(2025);         // 2025.1.1

        cout << "d1应该是2025.11.28，实际为：";
        d1.show();
        cout << "d2应该是2025.11,1， 实际为：";
        d2.show();
    ...
    if (1)
    {
        Date d1(2025, 11, 28), d2(d1), d3(d1);

        cout << "测试set，部分不变" << endl;

        d1.set(2007, 0, 0); // 2007.11.28
        d2.set(0, 10, 18);  // 2025.10.18
        d3.set(0, 0, 22);   // 2025.11.22

        cout << "d1应该是2007.11.28，实际为：";
        d1.show();
        cout << "d2应该是2025.10.18，实际为：";
        d2.show();
        cout << "d3应该是2025.11.22，实际为：";
        d3.show();
    ...
    if (1)
    {
        ...
        Date d12(2024, 2, 29), d13(2025, 10, 31);

        d12.set(2025, 0, 0); // 2025.2.1
        d13.set(0, 11, 0);   // 2025.11.1

        cout << "d12应该是2025.2.1， 实际为：";
        d12.show();
        cout << "d13应该是2025.11.1，实际为：";
        d13.show();
    ...
    if (1)
    {
        ...
        cout << "测试cout" << endl;
        cout << "d1应该是2025.11.28，实际为：" << d1 << endl;
    ...
    if (1)
    {
        ...
        cin >> d1;
        cout << "d1应该是2025.2.1，  实际为：" << d1 << endl;
        ...
        cin >> d1;
        cout << "d1应该是2025.1.10， 实际为：" << d1 << endl;

        cout << "请输入2025 11 31" << endl;
        cin >> d1;
        cout << "d1应该是2025.11.1， 实际为：" << d1 << endl;
    ...
    if (1)
    {
        ...
        cout << "d3应该是34567，实际为：" << int(d3) << endl;
        cout << "d4应该是45988，实际为：" << int(d4) << endl;
    ...
    if (1)
    {
        ...
        d2 = 25 + d1;
        cout << "d2应该是2025.12.23，   实际为：" << d2 << endl;

        d2 = d1 - 35;
        cout << "d2应该是2025.10.24，   实际为：" << d2 << endl;
        ...
        d1.set(2025, 2, 28);
        d2 = d1 + 3;
        cout << "d2应该是2025.3.3，     实际为：" << d2 << endl;

        d1.set(2025, 12, 28);
        d2 = d1 + 5;
        cout << "d2应该是2026.1.2，     实际为：" << d2 << endl;
        ...
        d1.set(2024, 12, 31);
        d2 = d1 + 366; //+平年
        cout << "d2应该是2026.1.1，     实际为：" << d2 << endl;
        ...
        d1.set(2025, 12, 19);
        d2.set(2025, 11, 28);
        cout << "d1-d2应该是21，        实际为：" << d1 - d2 << endl;
        cout << "d2-d1应该是-21，       实际为：" << d2 - d1 << endl;
        ...
        d1.set(2025, 11, 28);
        cout << "d1+21应该是2025.12.19，实际为：" << d1 + 21 << endl;
        cout << "25+d1应该是2025.12.23，实际为：" << 25 + d1 << endl;
        cout << "d1-35应该是2025.10.24，实际为：" << d1 - 35 << endl;
    ...
    if (1)
    {
        ...
        d1.set(2025, 11, 28);
        d2 = d1++;
        cout << "d1应该是2025.11.29，实际为：" << d1 << endl;
        cout << "d2应该是2025.11.28，实际为：" << d2 << endl;

        d1.set(2025, 12, 1);
        d2 = ++d1;
        cout << "d1应该是2025.12.2， 实际为：" << d1 << endl;
        cout << "d2应该是2025.12.2， 实际为：" << d2 << endl;

        d1.set(2025, 12, 1);
        d2 = d1--;
        cout << "d1应该是2025.11.30，实际为：" << d1 << endl;
        cout << "d2应该是2025.12.1， 实际为：" << d2 << endl;

        d1.set(2025, 12, 1);
        d2 = --d1;
        cout << "d1应该是2025.11.30，实际为：" << d1 << endl;
        cout << "d2应该是2025.11.30，实际为：" << d2 << endl;

        d1.set(2025, 12, 31);
        d2 = d1++;
        cout << "d1应该是2026.1.1，  实际为：" << d1 << endl;
        ...
        d1.set(2025, 2, 28);
        d2 = d1++;
        cout << "d1应该是2025.3.1，  实际为：" << d1 << endl;
        cout << "d2应该是2025.2.28， 实际为：" << d2 << endl;
        ...
        d1.set(2025, 3, 1);
        d2 = d1--;
        cout << "d1应该是2025.2.28， 实际为：" << d1 << endl;
        cout << "d2应该是2025.3.1，  实际为：" << d2 << endl;
