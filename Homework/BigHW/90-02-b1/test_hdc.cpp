...
int main(int argc, char** argv)
{
	...
	if (test_choise[T_MATHCURVE] == '1') {
		...
		struct {
			...
			{1234567, "测试", hdc_draw_Mathematical_curve_1234567},
			{2451317, "冯久恒", hdc_draw_Mathematical_curve_2451317},
			{0,NULL,NULL}
		};
	...
	if (test_choise[T_CUSTOM] == '1') {
		...
		struct {
			...
			{1234567, "测试", hdc_draw_cartoon_1234567, 400, 400},
			{2451317, "冯久恒", hdc_draw_cartoon_2451317, 400, 400},
			{0,NULL,NULL}
		};
		/* 显示显示助教哥哥/姐姐们画的卡通图像
		   注：调用函数前，先要添加对应的cpp并在.h中加函数声明
